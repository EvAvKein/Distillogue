const validationSettings = {
	abortEarly: false,
	stripUnknown: {
		// setting this to just "true" by default does the same thing as this object, but i prefer being explicit here (and prevent potential updates from modifying this)
		objects: true,
